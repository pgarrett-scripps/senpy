...
extern "C" {
    ...
    /// complete).
    ///
    BdalTimsdataDllSpec uint32_t tsf_read_line_spectrum(
        uint64_t handle,
        int64_t spectrum_id,
        double* index_array,
    ...
    /// complete).
    ///
    BdalTimsdataDllSpec uint32_t tsf_read_line_spectrum_with_width(
        uint64_t handle,
        int64_t spectrum_id,
        double* index_array,
        float* intensity_array,
    ...
    ///
    /// \returns 0 on error, otherwise the number of entries necessary for the output array
    /// of this call (if this is larger than the provided output array length, the result is not
    /// complete).
    ///
    BdalTimsdataDllSpec uint32_t tsf_read_profile_spectrum(
        uint64_t handle,
        int64_t spectrum_id,   
